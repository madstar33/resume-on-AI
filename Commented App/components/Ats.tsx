...
/* EN: Props interface `ATSProps` — documents what props this component expects.
   FA: اینترفیس پراپس `ATSProps` — مشخص می‌کند این کامپوننت چه پراپس‌هایی می‌پذیرد. */
interface ATSProps {
  score: number;
  suggestions: Suggestion[];
}

/* EN: React functional component `ATS` declared with React.FC type.
   FA: کامپوننت تابعی ری‌اکت `ATS` با نوع React.FC تعریف شده است. */
